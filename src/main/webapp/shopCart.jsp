                    ...
                    <form method="post" action="EmailSendingServlet">
                        ...
                        <c:choose>
                            <c:when test="${empty order.getLineItems()}">
                                <button type="submit" class="bg-indigo-500 font-semibold rounded-lg hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full disabled:bg-gray-500" disabled>Checkout</button>
                            </c:when>
                            <c:otherwise>
                                <button type="submit" class="bg-indigo-500 font-semibold rounded-lg hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Checkout</button>
                            </c:otherwise>
                        </c:choose>
                    </form>
                </div>
