...
<body>
    ...
    <div class="flex max-h-[600px] min-h-[300px] items-stretch px-[10%]">
        <div class="flex w-6/12 flex-col items-center p-4">
            <div class="mb-1 flex h-3/4 w-5/6 items-center overflow-hidden rounded-lg border">
                <img class="h-full w-full object-cover"
                     src="data:image/jpg;base64,${product.getProductimgBase64()}"/>
            </div>

            <div class="grid h-1/4 w-5/6 grid-cols-4 items-center gap-1">
                <img class="overflow-hidden rounded-lg border" src="https://shopimg.com/cdn/shop/products/royal_ss_crew_4f6f6c7b-c0be-4039-86ef-da55d549f45f_600x.jpg?v=1565623885" alt="sub-item-img" />
                <img class="overflow-hidden rounded-lg border" src="https://shopimg.com/cdn/shop/products/royal_ss_crew_4f6f6c7b-c0be-4039-86ef-da55d549f45f_600x.jpg?v=1565623885" alt="sub-item-img" />
                <img class="overflow-hidden rounded-lg border" src="https://shopimg.com/cdn/shop/products/royal_ss_crew_4f6f6c7b-c0be-4039-86ef-da55d549f45f_600x.jpg?v=1565623885" alt="sub-item-img" />
                <img class="overflow-hidden rounded-lg border" src="https://shopimg.com/cdn/shop/products/royal_ss_crew_4f6f6c7b-c0be-4039-86ef-da55d549f45f_600x.jpg?v=1565623885" alt="sub-item-img" />
            </div>
